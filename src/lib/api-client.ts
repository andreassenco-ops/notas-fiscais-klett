...
export const api = {
  ...
  emitirNfseLote: (items: Array<{
    ...
    results: Array<{ protocolo: string; success: boolean; chNFSe?: string; nNFSe?: string; xmlRetorno?: string; error?: string; dados?: { pacienteNome: string; cpf: string; valor: number; formaPagamento?: string } }>;
    total: number;
    emitidas: number;
    erros: number;
